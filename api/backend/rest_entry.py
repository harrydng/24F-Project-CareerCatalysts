...
from backend.recommendations.recommendations_routes import recommendations
...
def create_app():
    ...
    app.register_blueprint(recommendations, url_prefix = '/r')
    app.register_blueprint(users, url_prefix='/e')
